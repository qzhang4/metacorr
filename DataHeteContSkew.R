## data generation,continous items,true dist=Skewed, heterogeneous ##
library(MASS)
lp=1000
...
datadir=paste0('/gpfs/home/qzhang4/metacorr/Heterogeneous/DataHeteContSkew/cond',cond.idx+1000,'/')
for (sz in 1:nrow(Nn)) {
  ssize=Nn[sz,1]
  NS=Nn[sz,2]
